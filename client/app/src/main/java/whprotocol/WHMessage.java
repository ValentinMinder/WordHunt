 ...
 * - a header, which is a keyword defined in {@link whprotocol.WHProtocol.WHMessageHeader} <br>
...
public class WHMessage {
	 ...
	 *
	 * @see whprotocol.WHProtocol.WHMessageHeader
	 */
...
//                return new WHMessage(header, content);
                return new WHMessage(header, payload);
            case PING:
            case GRID_GET:
            case PING_REPLY:
			...
			case AUTH_REQUIRED_403:
                ...
                Log.d("Res","payload" + content.toString());
                break;
			default:
	...
	public static WHMessage readMessage(BufferedReader reader)
        ...
        Log.d("reply","To validate: " + sb.toString());
