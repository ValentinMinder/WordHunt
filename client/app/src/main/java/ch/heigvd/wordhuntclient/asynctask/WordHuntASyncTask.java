...
import ch.heigvd.wordhuntclient.activities.DevActivity;
...
public class WordHuntASyncTask extends AsyncTask<WHMessage, Object, WHMessage> {
    ...
    private void init() throws UnknownHostException, IOException {
        ...
        String dstAddress = DevActivity.preferences.getString(
                DevActivity.prefLastIP, "localhost");

        Log.d("SERVEUR", "dstAddress: " + dstAddress);
//        String dstAddress = caller.ipLocation();

        int port = DevActivity.preferences.getInt("SERVER_PORT", 1234);
